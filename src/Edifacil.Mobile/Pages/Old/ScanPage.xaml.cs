...
public partial class ScanPage : ContentPage
{
    ...
    protected override async void OnAppearing()
    {
        ...
        // Aguarda permissÃ£o e inicializa cÃ¢mera (Expert safe check)
        ...
        if (status == PermissionStatus.Granted)
        {
            MainThread.BeginInvokeOnMainThread(async () => {
                // ForÃ§a o trigger de carregamento da cÃ¢mera no Grid
    ...
    {
        // 1. Capturar Bitmap/Frame de Alta ResoluÃ§Ã£o de dentro da Lente
    ...
    {
        // Limpar imagem para liberar memÃ³ria
...
#else
        await DisplayAlert("InformaÃ§Ã£o", "ReanÃ¡lise de Ã¡rea sÃ³ estÃ¡ disponÃ­vel em Android.", "OK");
#endif
    }
    ...
    private async void OnOverlayTapped(object sender, TappedEventArgs e)
    {
        ...
        // Hit Testing MatemÃ¡tico usando Inversive Matrix 
        if (System.Numerics.Matrix3x2.Invert(_viewModel.TransformationMatrix, out var inverted))
        {
            // O toque Ã© na View. Transforma para o espaÃ§o de mundo virtual:
    ...
    private void ApplyZoom(double delta)
    {
        ...
        // Focado no meio visual exato da tela. O Canvas nativo trabalha em Pixels FÃ­sicos na Matriz (ignora DPs).
    ...
    private void OnPanUpdated(object sender, PanUpdatedEventArgs e)
    {
        ...
        {
            // O sensor de toque de Android envia os deltas de forma invertida e transposta em relaÃ§Ã£o ao GraphicsView.
            // Para eliminar a "Velocidade Parallax Lenta", multplicamos pelos Pixels FisÃ­cos por via de Densidade:
            double density = DeviceDisplay.MainDisplayInfo.Density;
