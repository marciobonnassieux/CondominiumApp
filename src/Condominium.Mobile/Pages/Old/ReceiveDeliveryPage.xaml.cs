...
public partial class ReceiveDeliveryPage : ContentPage
{
    ...
    private async void LoadUnitsToComboBox()
    {
        ...
        // Fallback Mock local caso a API não seja encontrada na rede WiFi
    ...
    // Ações do Pop-Up (Combo-box Virtual)
    ...
    private async void OnScanClicked(object? sender, EventArgs e)
    {
        ...
        {
            await DisplayAlertAsync("Aviso", "A câmera recusa permissão nativa.", "OK");
        }
    }
    ...
    private async void OnRegisterClicked(object? sender, EventArgs e)
    {
        ...
        {
            await DisplayAlertAsync("Aviso", "Escolha na lupa de qual Unidade é este pacote.", "OK");
            return;
        }
        if (string.IsNullOrWhiteSpace(BarcodeEntry.Text))
        {
            await DisplayAlertAsync("Aviso", "Faça o Scan da etiqueta primeiro.", "OK");
            return;
        }
